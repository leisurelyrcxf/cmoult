...
state = sys.modules['django.db.migrations.state']
...
st1Update = SafeRedefineMethodUpdate(state.ProjectState,state.ProjectState.remove_model,remove_model,"remove_model")

st2Update = SafeRedefineMethodUpdate(state.ProjectState,state.ProjectState.reload_model,reload_model,"reload_model")
...
class ModelUpdate(Update):
    def wait_alterability(self):
        return True
    def apply(self):
        redefineClass(state,state.ModelState,ModelState)


st3Update = ModelState()
