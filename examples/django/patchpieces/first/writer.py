...
writer = sys.modules['django.db.migrations.writer']
...
class WriterUpdate(Update):
    def wait_alterability(self):
        return True
    def apply(self):
        redefineClass(writer,writer.MigrationWriter,MigrationWriter)


def transformer(obj):
    obj.identation = 2
        
writ1Update = EagerConversionUpdate(writer.OperationWriter,OperationWriter,transformer)
writ2Update = WriterUpdate()
