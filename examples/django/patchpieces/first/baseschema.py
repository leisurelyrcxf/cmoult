...
class BaseUpdate(Update):
    def wait_alterability(self):
        return True
    def apply(self):
        redefineClass(schema,schema.BaseDatabaseSchemaEditor,BaseDatabaseSchemaEditor)



sc1Update = SafeRedefineUpdate(schema,schema._related_non_m2m_objects,_related_non_m2m_objects,"_related_non_m2m_objects")
