...
operations = sys.modules['django.db.backends.mysql.operations']
...
class DBUpdate(Update):
    def wait_alterability(self):
        return True
    def apply(self):
        redefineClass(operations,operations.DatabaseOperations,DatabaseOperations)
