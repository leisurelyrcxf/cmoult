...
echo "You can now connect on localhost:2121"
echo "The server is running version 1.1.0"
#Update to 1.2.0
echo "Press any key to update to version 1.2.0"
read
echo "Submitting update"
echo "update update1.1.0-1.2.0.py" | netcat $hostname 4242
sleep 1
echo "The server should run in version 1.2.0 shortly"
#update to 1.3.0
