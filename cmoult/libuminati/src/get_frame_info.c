...
static int _eh_get_cfa_from_dwfl_module(Dwfl_Module* mod, Dwarf_Addr pc, um_frame* context, um_data* dbg){
  Dwarf_CFI* cfi;
  Dwarf_Addr bias;
  cfi = dwfl_module_eh_cfi(mod, &bias);
  if(cfi == NULL){
    dwarf_error("failed in dwfl_module_eh_cfi()");
    return 1;
  }
...
static int _dwarf_get_cfa_from_dwfl_module(Dwfl_Module* mod, Dwarf_Addr pc, um_frame* context, um_data* dbg){
  Dwarf_CFI* cfi;
  Dwarf_Addr bias;
...
int _eh_get_register_from_dwfl_module(unsigned int reg, Dwfl_Module* mod, Dwarf_Addr pc, um_frame* context, um_data* dbg){
  Dwarf_CFI* cfi;
  Dwarf_Addr bias = 0;
  cfi = dwfl_module_eh_cfi(mod, &bias);
  if(cfi == NULL){
...
int _dwarf_get_register_from_dwfl_module(unsigned int reg, Dwfl_Module* mod, Dwarf_Addr pc, um_frame* context, um_data* dbg){
  Dwarf_CFI* cfi;
  Dwarf_Addr bias = 0;
  cfi = dwfl_module_dwarf_cfi(mod, &bias);
  if(cfi == NULL){
...
int get_cfa_from_dwfl_module(Dwfl_Module* mod, Dwarf_Addr pc, um_frame* context, um_data* dbg){
  if(_eh_get_cfa_from_dwfl_module(mod, pc, context, dbg) != 0){
    return _dwarf_get_cfa_from_dwfl_module(mod, pc, context, dbg);
  }
//  if(_dwarf_get_cfa_from_dwfl_module(mod, pc, context, dbg) != 0){
//    return _eh_get_cfa_from_dwfl_module(mod, pc, context, dbg);
//  }
}

int get_register_from_dwfl_module(unsigned int reg, Dwfl_Module* mod, Dwarf_Addr pc, um_frame* context, um_data* dbg){
  if(_eh_get_register_from_dwfl_module(reg, mod, pc, context, dbg) != 0){
    return _dwarf_get_register_from_dwfl_module(reg, mod, pc, context, dbg);
  }
//  if(_dwarf_get_register_from_dwfl_module(reg, mod, pc, context, dbg) != 0){
//    return _eh_get_register_from_dwfl_module(reg, mod, pc, context, dbg);
//  }
}
